...
const SCHEMA = [
  ...
  `CREATE TABLE IF NOT EXISTS poultry_movements (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
const MIGRATIONS: string[] = [
  ...
  "ALTER TABLE moutons ADD COLUMN poultry_kind TEXT",
  "ALTER TABLE moutons ADD COLUMN acquisition_date TEXT",
  "ALTER TABLE moutons ADD COLUMN weight_kg REAL",
  "ALTER TABLE expenses ADD COLUMN target_type TEXT",
  "ALTER TABLE expenses ADD COLUMN target_id INTEGER",
];
